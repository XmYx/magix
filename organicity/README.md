...
| Presentation | Pedestrians on the pavements, optional ordered dithering and light glow (bloom), advisors and news, overlays, day and night, a generated soundscape, photo mode with PNG export, touch controls, colour-blind palette, UI scale, reduced motion, share links and files |
...
```bash
node scripts/organicity-test.mjs            # 105 headless simulation tests
