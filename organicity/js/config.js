...
export const SERVICES = {
  ...
  airfield: { cat: 'svc', name: 'Municipal airfield', w: 36, d: 14, cost: 40000, upkeep: 1000, aviation: true, freight: 80, unlock: 2500, exportBonus: 0.02, tourism: 1000, noise: 0.6, desc: 'A small airport with a runway and scheduled airplanes. Needs road access, electricity and water.' },
  airport:    { aviation: true, cat: 'svc', name: 'Airport',             w: 44, d: 16, cost: 120000, upkeep: 3000, freight: 250, unlock: 8000, exportBonus: 0.05, tourism: 3000, noise: 0.9, desc: 'Air freight, tourists and business travel. Offices want to be near it; neighbours hate the noise.' },
